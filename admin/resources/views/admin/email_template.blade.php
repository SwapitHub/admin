							...
							aria-labelledby="top-profile-tab">
								<form action="{{ $url_action }}" method="POST" class="needs-validation" novalidate >
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
											<select name="group" class="form-control">
                                                ...
                                                <option value="send_registratino_email" {{ $obj != null && $obj['group'] == 'send_registratino_email'?'selected':''}}>Send registratino email</option>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-xl-8 col-md-7">
                                            <textarea name="content"  cols="82" rows="10">{!! old()?old('content'):$obj['content']??'' !!}</textarea>
											@error('content')
											<div class="invalid-feedback">{{ $message }}</div>
											@enderror
										</div>
