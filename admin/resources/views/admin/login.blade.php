...
<html lang="en">
	...
	<form action="{{ route('admin.auth') }}" method="POST" class="form-horizontal auth-form" novalidate>
	@csrf
	...
	id="customControlAutosizing" id="remember" {{ old('remember') ? 'checked' : '' }}>
