...
<head>
    ...
    <link rel="icon" href="{{ env('AWS_URL') }}public/storage/{{ $info['favicon'] }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ env('AWS_URL') }}public/storage/{{ $info['favicon'] }}"
        type="image/x-icon">
                                            ...
                                            <div class="form-terms">
                                                <div class="form-check mesm-2">
                                                    <input type="checkbox" name="remember" class="form-check-input"
                                                        id="customControlAutosizing" id="remember"
