...
<html lang="en">
	...
	<head>
		...
		<link rel="icon" href=" {{ env('AWS_URL') }}public/storage/{{ $webInfo->favicon }}" type="image/x-icon">
		<link rel="shortcut icon" href=" {{ env('AWS_URL') }}public/storage/{{ $webInfo->favicon }}" type="image/x-icon">
		...
		<link rel="stylesheet" type="text/css" href=" {{ env('AWS_URL') }} {{ asset('admin') }}/css/vendors/chartist.css">
		<!-- Font Awesome-->
		...
		<style>
			body {
            font-family: Nunito; /* Change the font family to your desired font stack */
			}
			.custom-theme {
						...
						<ul class="nav-menus">
							...
							<li class="onhover-dropdown">
								<div class="media align-items-center">
									...
									<img class="align-self-center pull-right img-50 blur-up lazyloaded" src=" {{ env('AWS_URL') }}public/storage/{{ Auth::user()->designation_icon }}" alt="{{ Auth::user()->name }}">
									@else
								<img class="align-self-center pull-right img-50 blur-up lazyloaded" src="{{ asset('public') }}/user_icon.jpg" alt="{{ Auth::user()->name }}"></a>
                                @endif
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-sidebar">
                <div class="main-header-left d-none d-lg-block">
                    <div class="logo-wrapper"><a href="{{ url('dashboard') }}"><img class="blur-up lazyloaded"
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <div class="sidebar-user">
                        <a href="{{ url('dashboard') }}">
                            @if(!empty( Auth::user()->designation_icon))
						<img class="img-60" src=" {{ env('AWS_URL') }}public/storage/{{ Auth::user()->designation_icon }}" alt="{{ Auth::user()->name }}"></a>
						@else
				...
				<ul class="sidebar-menu">
					<li>
						<a class="sidebar-header" href="{{ url('dashboard') }}">
					...
					<li>
						...
						<ul class="sidebar-submenu">
							...
							<li>
								<a href="{{ route('admin.permission.list') }}"><i class="fa fa-circle"></i>Permissions
								</a>
							</li>
						</ul>
					</li>
...
<script src=" {{ asset('admin') }}/js/datatables/custom-basic.js"></script>
...
{{-- <script src=" {{ asset('admin') }}/js/editor/ckeditor/ckeditor.custom.js"></script> --}}
...
<!-- Google chart js-->
<script src=" {{ asset('admin') }}/js/chart/google/google-chart-loader.js"></script>
<!--Report chart-->
